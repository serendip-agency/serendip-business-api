[Serendip Business API](../README.md) > [Auth](../modules/auth.md) > [UserModel](../classes/auth.usermodel.md)
...
*Defined in node_modules/serendip-business-model/src/auth/UserModel.ts:6*
